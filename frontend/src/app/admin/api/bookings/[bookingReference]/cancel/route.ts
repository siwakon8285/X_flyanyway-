...
export const POST = async (request: Request, { params }: { params: Promise<{ bookingReference: string }> }) => {
  ...
  return forwardAdminBookingRequest(request, `/admin/bookings/${encodeURIComponent(reference)}/cancel`);
};
